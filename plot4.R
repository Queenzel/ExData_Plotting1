...
>with(sub_consumption, { plot (Global_active_power~Datetime, type="l",  ylab="Global Active Power ", xlab="")})
>with(sub_consumption, {plot ( Voltage~Datetime, type="l",  ylab="Voltage", xlab="datetime")})
>with(sub_consumption, {plot (Sub_metering_1~Datetime, type="l", 
...
>with(sub_consumption, { plot(Global_reactive_power~Datetime, type="l", ylab="Global_reactive_power ",xlab="datetime")})
